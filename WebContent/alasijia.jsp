        ...
        <li class="navli"><a href="#">管理员注册</a>
            <ul>
                ...
                <table class=table11_3>
                    ...
                    <c:forEach var="a" items="${alasijia }">
                    	<tr><td>${a.getType() }</td><td>${a.getAge() }</td><td>${a.getPrice() }</td><td>${a.getColor() }</td><td>${a.getName() }</td><td>${a.getImmunity() }</td><td>${a.getShape() }</td><td>${a.getHair() }</td><td>${a.getLike() }</td><td>${a.getKind() }</td><td>${a.getHome() }</td><td>${a.getBody() }</td><td><a href="addcar?id=${a.getId() }">是</a></td></tr>
                    </c:forEach>
                </table>
            </div>
